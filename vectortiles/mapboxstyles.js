// Styles for the mapbox-streets vector tile data set. 
// Based on https://openlayers.org/en/v5.2.0/examples/resources/mapbox-streets-v6-style.js

export default function createMapboxStreetsStyle(Style, Fill, Stroke, Icon, Text) {
